...
const OwnedPage = () => {
  ...
  console.log("OWED: ", ownedNFTs);
  return (
    <div className="flex w-full flex-col">
      <div className = "flex flex-wrap">
      {ownedNFTs?.map((nft) => <NFTCard nft={nft} className = "mr-4 mb-4" key = {nft.id}/>)}
    </div>
    ...
    <div className = "flex flex-wrap">
      {ownedListedNFTs?.map((nft) => <NFTCard nft={nft} className = "mr-4 mb-4" key = {nft.id}/>)}
    </div>
    </>
    }
